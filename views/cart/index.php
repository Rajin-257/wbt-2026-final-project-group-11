...
<?php if (empty($cartItems)): ?>
    <div class="empty-state">
        ...
        <a href="<?= BASE_URL ?>/index.php?page=home" class="btn btn--primary">Browse Medicines</a>
    </div>
<?php else: ?>
    ...
    <div class="cart-layout">
                    ...
                    <tr class="cart-row" data-cart-id="<?= $item['cart_id'] ?>" data-stock="<?= $item['stock'] ?>">
                        <td class="cart-row__name">
                            <?php if ($item['image_path']): ?>
                                <img src="<?= BASE_URL . '/public/uploads/medicines/' . e($item['image_path']) ?>" alt="" class="cart-thumb">
                            <?php else: ?>
        ...
        <aside class="cart-summary">
            ...
            <a href="<?= BASE_URL ?>/index.php?page=home" class="btn btn--outline btn--full" style="margin-top:.5rem;">
                Continue Shopping
            </a>
        </aside>
    </div>
